...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _channels_chat_room_channel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../channels/chat_room_channel */ "./app/javascript/channels/chat_room_channel.js");
...
$(document).on('turbolinks:load', function () {
  $("form#set_name").on('submit', function (e) {
    ...
    _channels_chat_room_channel__WEBPACK_IMPORTED_MODULE_0__["default"].announce({
      name: name,
      type: 'join'
    });
  ...
  $("form#send_message").on('submit', function (e) {
    ...
    if (message.length > 0) {
      _channels_chat_room_channel__WEBPACK_IMPORTED_MODULE_0__["default"].speak(message);
      $('#message').val('');
    }
  });
...
/******/ });
//# sourceMappingURL=application-918e5dee3a0ceab6f2b2.js.map