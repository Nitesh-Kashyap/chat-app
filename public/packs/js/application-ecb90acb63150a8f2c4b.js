...
/* WEBPACK VAR INJECTION */(function($) {!(function webpackMissingModule() { var e = new Error("Cannot find module '../channels/chat_room_channel'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
$(document).on('turbolinks:load', function () {
  $("form#set_name").on('submit', function (e) {
    ...
    !(function webpackMissingModule() { var e = new Error("Cannot find module '../channels/chat_room_channel'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).announce({
      name: name,
      type: 'join'
    });
  ...
  $("form#send_message").on('submit', function (e) {
    ...
    if (message.length > 0) {
      !(function webpackMissingModule() { var e = new Error("Cannot find module '../channels/chat_room_channel'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).speak(message);
      $('#message').val('');
    }
  });
...
/******/ });
//# sourceMappingURL=application-ecb90acb63150a8f2c4b.js.map